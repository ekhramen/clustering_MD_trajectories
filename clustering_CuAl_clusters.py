...
######################################  LOW MODE MOLECULAR DYNAMICS ANALYSIS ########################################
#%%
...
#dic = os.getcwd()
dic = 'O:\\Ongoing_Projects\\Influence of Cu Concentration on the Equilibrium of Cu_Al-oxo Cluster Speciation in Mordenite for Oxidative Transformations of Methane\\Cu2AlO4H'
...
class Align_min:
    ...
    def print_rmsd_tajectories(df):
        ...
        plt.show()
        # save the figure
        #fig.savefig(dic + '\\..\\clustering\\VS_923K\\Sil_sc_vs_923K.png', bbox_inches='tight', dpi=300)
    ...
    def do_clustering(self, number_of_clusters):
        ...
        #plt.savefig(dic + '\\..\\clustering\\all\\t-SNE_all.svg', dpi=300)
        plt.show()
